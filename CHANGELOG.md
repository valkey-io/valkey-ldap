...
## [1.1.1] - 2026-06-29
### Changed
- Fixed CHANGELOG entry for 1.1.0 release
- Add module flag for atomic slot migration
## [1.1.0] - 2026-05-21
### Added
...
[unreleased]: https://github.com/valkey-io/valkey-ldap/compare/1.1.1...HEAD
[1.1.1]: https://github.com/valkey-io/valkey-ldap/releases/tag/1.1.1
